...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $modules = [
            ...
            'quotations' => ['view', 'create', 'edit', 'delete', 'approve', 'revise'],
            'work_orders' => ['view', 'create', 'edit', 'delete', 'close'],
            'quality_controls' => ['view', 'create', 'edit', 'delete', 'manage'],
            'vehicle_deliveries' => ['view', 'create', 'edit', 'delete', 'manage'],
