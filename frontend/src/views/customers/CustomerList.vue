  ...
  <div class="space-y-4">
    <div class="flex justify-between items-end">
      <div>
        ...
        <p class="text-sm text-slate-500 mt-1">Manage your customer base, vehicles, and billing history.</p>
      </div>
      <router-link :to="{ name: 'customers.create' }" v-if="authStore.hasPermission('customer.create')" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm transition-colors flex items-center gap-2">
