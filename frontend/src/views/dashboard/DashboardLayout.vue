  ...
  <div class="min-h-screen bg-gray-50 text-slate-800 flex overflow-hidden">
    ...
    >
      ...
      <nav class="p-4 space-y-1 flex-1 overflow-y-auto">
        ...
        <router-link :to="{ name: 'workshop.intake' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-650 !border-indigo-650 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.inspection' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.diagnosis' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
          <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
          Diagnosis Center
        </router-link>

        <router-link :to="{ name: 'workshop.quotation' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.approvals' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.work-orders' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.technician-tasks' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.bays' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.parts-consumption' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.qc' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
          <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          QC Verification
        </router-link>

        <router-link :to="{ name: 'workshop.delivery' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.warranty-comeback' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <router-link :to="{ name: 'workshop.live-board' }" class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all border-l-3 border-transparent" active-class="!text-indigo-655 !border-indigo-655 bg-indigo-50/50 shadow-sm">
        ...
        <div class="px-4 py-2 text-xs font-bold text-slate-400 uppercase tracking-wider mt-4 font-sans">Core Entities</div>
